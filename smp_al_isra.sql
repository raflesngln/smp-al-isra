...
MySQL - 5.5.5-10.1.13-MariaDB : Database - smp_al_isra
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`smp_al_isra` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `siswa`(`NIS`,`nomor_daftar`,`tgl_verifikasi`,`nama_lengkap`,`jenis_kelamin`,`berat`,`tinggi`,`golongan_darah`,`nik`,`agama`,`tempat_lahir`,`tgl_lahir`,`anak_ke`,`jumlah_bersaudara`,`tempat_tinggal`,`asal_sekolah`,`nama_ayah`,`nama_ibu`,`tgl_lahir_ayah`,`tgl_lahir_ibu`,`pendidikan_ayah`,`pendidikan_ibu`,`pekerjaan_ayah`,`pekerjaan_ibu`,`penghasilan_ayah`,`penghasilan_ibu`,`alamat_ayah`,`alamat_ibu`,`pass_photo`,`ijasah`,`kk`,`traskrip_nilai`,`kelas`) values ('2017081200001','PSB20170800001','2017-08-12 11:01:11','Alan Rochim','pria',55,166,'A','12134555','islam','serang','2000-01-01',2,5,'jakarta barat cengkareng','SDN 1 JAKARTA BARAT','anto','surti',1945,1954,'SMA','SMP','PNS','BURUH',4000000,3000000,'serang','medan','cs-pitchbasicstats-7-638.jpg','news.jpg','profil.jpg','staff guru.jpg','1A'),('2017081200002','PSB20170800002','2017-08-12 11:01:25','ijat','pria',77,177,'a','215265162','islam','jakarta barat','2002-03-03',2,3,'cengkareng','sdn 11','anto','mawar',1946,1948,'SMA','SMP','karyawan','buruh',4000000,3500000,'cengkareng','grogol','download.png','harga.png','build.png','logo.png','1A');
...
insert  into `verifikasi_daftar`(`id_verifikasi`,`nomor_daftar`,`tgl_verifikasi`,`status_verifikasi`,`id_admin`) values (1,'PSB20170800001','2017-08-12 07:25:49','ya',0),(2,'PSB20170800002','2017-08-12 09:57:01','ya',0);
